...
SOpener@ GetOpenInfo()
{
	return SOpener({
		{Factory::armlab, array<SQueue> = {
			//raider
			SQueue(0.4f, {SO(RT::BUILDER), SO(RT::SCOUT, 10), SO(RT::RAIDER, 2), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER), SO(RT::RAIDER)}),
			//builder
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::SCOUT, 10), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER, 3), SO(RT::RAIDER, 3), SO(RT::SUPPORT), SO(RT::RAIDER)}),
			//standard
			SQueue(0.3f, {SO(RT::SCOUT, 10), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::BUILDER)})
		}},
		{Factory::armvp, array<SQueue> = {
			//standard
			SQueue(0.4f, {SO(RT::SCOUT, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER), SO(RT::RAIDER)}),
			//early scout push
			SQueue(0.3f, {SO(RT::SCOUT, 10), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER)}),
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER)})
		}},
		...
		{Factory::corlab, array<SQueue> = {
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER), SO(RT::RAIDER, 2)}),
			SQueue(0.3f, {SO(RT::RAIDER, 10), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::RIOT), SO(RT::BUILDER), SO(RT::RAIDER, 2)}),
			SQueue(0.4f, {SO(RT::RAIDER, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER)})
		}},
		{Factory::corvp, array<SQueue> = {
			...
			SQueue(0.3f, {SO(RT::SCOUT, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER)}),
			// scout start
			//SQueue(0.2f, {SO(RT::SCOUT, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER)}),
			//defensive eco start
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER)})
		}},
		...
		{Factory::leglab, array<SQueue> = {
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER, 10), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER), SO(RT::RAIDER, 2)}),
			SQueue(0.3f, {SO(RT::RAIDER, 10), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::RIOT), SO(RT::BUILDER), SO(RT::RAIDER, 2)}),
		...
		{Factory::legvp, array<SQueue> = {
			//standard
			SQueue(0.4f, {SO(RT::SCOUT, 10), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::BUILDER), SO(RT::RAIDER, 2)}),
			// raider serial production
			SQueue(0.3f, {SO(RT::SCOUT, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::BUILDER)}),
			// scout start
			//SQueue(0.2f, {SO(RT::SCOUT, 10), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER)}),
